...
> **Capture:** Datacenter → Summary with the log panel visible along the bottom of the
> window.
...
> **Capture:** The bottom panel with the **Tasks** tab selected and several tasks
> listed.
...
> **Capture:** The same panel showing its full column set — start time, end time, node,
> user, description, and status.
...
> **Capture:** A task opened by double-clicking it, showing the **Output** and
> **Status** tabs.
...
> **Capture:** The bottom panel switched to the **Cluster log** tab.
